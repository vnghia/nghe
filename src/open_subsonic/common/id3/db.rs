...
pub struct SongId3Db {
    ...
    #[diesel(select_expression_type = any_value_text<albums::name>)]
    pub album: String,
...
impl From<BasicSongId3Db> for SongId3 {
    fn from(value: BasicSongId3Db) -> Self {
        Self::new(
            ...
            value.format,
            value.bitrate as _,
            value.bit_depth.map(|v| v as _),
            value.sample_rate as _,
            value.channel_count as _,
            value.album_id,
...
impl SongId3Db {
    pub async fn into(self, pool: &DatabasePool) -> Result<SongId3> {
        ...
        Ok(SongId3 {
            ...
            bit_depth: self.basic.bit_depth.map(|v| v as _),
            sampling_rate: self.basic.sample_rate as _,
            channel_count: self.basic.channel_count as _,

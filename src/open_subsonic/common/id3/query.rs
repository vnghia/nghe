use diesel::dsl::{
    not, AsSelect, Eq, Filter, GroupBy, InnerJoin, InnerJoinOn, IsNull, LeftJoin, Select,
};
...
pub type GetSongArtistId3Db = Select<
    GroupBy<
        InnerJoinOn<
            InnerJoin<
                LeftJoin<GetBasicArtistId3Db, songs_album_artists::table>,
                songs_artists::table,
            >,
            songs::table,
...
pub type GetNoAlbumArtistId3Db = Filter<GetSongArtistId3Db, IsNull<songs_album_artists::song_id>>;
...
pub fn get_no_album_artist_id3_db() -> GetNoAlbumArtistId3Db {
    get_song_artist_id3_db().filter(songs_album_artists::song_id.is_null())
}
...
mod tests {
    ...
    async fn test_get_album_artist_id3_db() {
        ...
        assert_eq!(artists[0].basic.no_id.name, "artist-album-1");
        assert_eq!(artists[0].album_count, 1);
        assert_eq!(artists[1].basic.no_id.name, "artist-album-2");
    ...
    async fn test_get_album_artist_id3_db_compilation() {
        ...
        assert_eq!(artists[1].basic.no_id.name, "artist-album-2");
        assert_eq!(artists[1].album_count, 2);
        assert_eq!(artists[2].basic.no_id.name, "artist-no-album-1");
        assert_eq!(artists[2].album_count, 1);
        assert_eq!(artists[3].basic.no_id.name, "artist-no-album-2");
    ...
    async fn test_get_song_artist_id3_db() {
        ...
        assert_eq!(artists[1].album_count, 0);
        assert_eq!(artists[2].basic.no_id.name, "artist-no-album-2");
        assert_eq!(artists[2].album_count, 0);

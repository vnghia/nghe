                                ...
                                (
                                    html::div().class("flex justify-start items-center").child((
                                        html::button()
                                            ...
                                            .class(
                                                "p-2 mr-2 text-gray-600 rounded-lg cursor-pointer \
                                                 md:hidden hover:text-gray-900 hover:bg-gray-100 \
                                                 focus:bg-gray-100 dark:focus:bg-gray-700 \
                                                 focus:ring-2 focus:ring-gray-100 \
                                                 dark:focus:ring-gray-700 dark:text-gray-400 \
                                                ...
                                                svg::svg()
                                                    ...
                                                    .child(
                                                        svg::path()
                                                            ...
                                                            .attr(
                                                                "d",
                                                                "M3 5a1 1 0 011-1h12a1 1 0 110 \
                                                                 2H4a1 1 0 01-1-1zM3 10a1 1 0 \
                                                                 011-1h6a1 1 0 110 2H4a1 1 0 \
                                                                 01-1-1zM3 15a1 1 0 011-1h12a1 1 \
                                                ...
                                                svg::svg()
                                                    ...
                                                    .child(
                                                        svg::path()
                                                            ...
                                                            .attr(
                                                                "d",
                                                                "M8 4a4 4 0 100 8 4 4 0 000-8zM2 \
                                        ...
                                        html::div()
                                            ...
                                            .child((
                                                html::div().class("py-3 px-4").child((
                                                    ...
                                                    html::span()
                                                        .class(
                                                            "block text-sm text-gray-900 truncate \
                                                             dark:text-white",
                                                        )

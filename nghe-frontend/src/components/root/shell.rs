...
pub fn Shell<IV: IntoView + 'static>(
    ...
    html::div().class("antialiased bg-gray-50 dark:bg-gray-900").child((
                ...
                html::div().class("flex flex-wrap justify-between items-center").child((
                                ...
                                svg::svg()
                                    ...
                                    .child(
                                        svg::path()
                                            ...
                                            .attr(
                                                "d",
                                                "M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 \
                                                 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 \
                    ...
                    html::div().class("flex items-center lg:order-2").child((
                        ...
                        html::div()
                            .id("dropdown")
                            .class(
                                "hidden z-50 my-4 w-56 text-base list-none bg-white rounded \
                            ...
                            .child((
                                html::div().class("py-3 px-4").child((
                                    ...
                                    html::span()
                                        .class(
                                            "block text-sm text-gray-900 truncate dark:text-white",
                                        )
        ...
        html::aside()
            ...
            .child(html::div().class("overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800")),

                            ...
                            html::nav()
                                .class(
                                    "bg-white border-b border-gray-200 px-4 py-2.5 \
                                     dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 \
                                     top-0 z-50",
                                )
                                .child(
                                    html::div()
                                            ...
                                            html::div()
                                                ...
                                                .child((
                                                    html::button()
                                                        ...
                                                        .class(
                                                            "p-2 mr-1 text-gray-500 rounded-lg \
                                                             md:hidden hover:text-gray-900 \
                                                    ...
                                                    html::button()
                                                        ...
                                                        .class(
                                                            "flex mx-3 text-sm bg-gray-800 \
                                                             rounded-full md:mr-0 focus:ring-4 \
                                                             focus:ring-gray-300 \
                                                             dark:focus:ring-gray-600",
                                                        )
                                                        .child((
                                                    ...
                                                    html::div()
                                                        .id("dropdown")
                                                        .class(
                                                            "hidden z-50 my-4 w-56 text-base \
                                                             list-none bg-white rounded divide-y \
                            ...
                            html::aside()
                                ...
                                .class(
                                    "fixed top-0 left-0 z-40 w-64 h-screen pt-14 \
                                     ...
                                     border-gray-200 md:translate-x-0 dark:bg-gray-800 \
